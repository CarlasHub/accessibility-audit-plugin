...
import { buildWorkflow, normalizeTargetUrl } from '../site/workflow.js';
...
describe('landing page workflow generator', () => {
  ...
  it('creates a standalone workflow with a pinned report uploader', () => {
    ...
    expect(workflow).toContain("default: 'https://example.com/it''s-here'");
    expect(workflow).toContain('actions/upload-artifact@043fb46d1a93c77aae656e7c1c64a875d1fc6a0a');
    expect(workflow).toContain('${{ inputs.url }}');
