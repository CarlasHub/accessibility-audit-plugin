...
describe('portable audit archive', () => {
  it('packages the HTML report, workbook, JSON, and screenshot directory beside the output folder', async () => {
    ...
    const archivePath = await createAuditArchive(outputDir, reportPath, htmlPath, jsonPath);
