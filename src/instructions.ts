...
2. Populate Image Inventory with one row per unique finding screenshot and a portable relative hyperlink. Do not embed screenshots and do not create a Screen Reader Failures worksheet.
